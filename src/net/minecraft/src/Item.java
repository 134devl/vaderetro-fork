...
public class Item {
	...
	public static Item ar15Bullet = (new Item(128)).setIconCoord(6, 8).setItemName("ar15Bullet");
	public static Item ar15 = (new ItemAR15(135)).setIconCoord(6, 10).setItemName("ar15");
	public static Item icon = (new ItemIcon(139)).setIconCoord(5, 12).setItemName("icon");
