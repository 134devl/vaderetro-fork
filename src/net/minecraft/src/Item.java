...
public class Item {
	...
	public static Item objSpawner = (new ItemObjSpawner(161)).setIconCoord(6, 11).setItemName("objSpawner");
	public static Item uvMapGenerator = (new ItemUVMapGenerator(162)).setIconCoord(6, 12).setItemName("uvMapGenerator");
